...
namespace War.Server.Domain
{
    ...
    public class PasswordResetRequest : Entity, IValidatableObject
    {
        ...
        public PasswordResetRequest(User user, bool isNewUser)
        {
        ...
        public async Task SetPassword(string password)
        {
            ...
            await Repository<User>.SaveAsync(this.User);
            await Repository<PasswordResetRequest>.SaveAsync(this);
        }
